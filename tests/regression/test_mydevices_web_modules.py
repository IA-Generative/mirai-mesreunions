"""End-to-end tests pour les blueprints PR3 de ``mydevices-web``.
...
mydevices-web est exposé sur ``http://localhost:8080``. Les tests sont
...
INDEX_HTML = REPO_ROOT / "services" / "mydevices-web" / "app" / "templates" / "index.html"
